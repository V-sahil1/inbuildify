  ...
  GeneralSettings.init(
    {
      ...
      show_reference_id_in_pdf: {
        type: DataTypes.ENUM("document_id", "job_id", "document_id_and_job_id", "hide_document_id_and_job_id"),
        defaultValue: "hide_document_id_and_job_id",
      },
      job_id_label: { type: DataTypes.STRING(100), allowNull: true },
      createdAt: { type: DataTypes.DATE },
      updatedAt: { type: DataTypes.DATE },
    },
    { sequelize, tableName: "general_settings", modelName: "GeneralSettings", underscored: true }
  );
