...
export class SchedulerSettings extends Model {
  static associate(models) {
    SchedulerSettings.belongsTo(models.Company, { foreignKey: "company_id", as: "company" });
    SchedulerSettings.belongsTo(models.Builder, { foreignKey: "builder_id", as: "builder" });
    SchedulerSettings.belongsTo(models.Users, { foreignKey: "created_by", as: "createdByUser" });
    SchedulerSettings.belongsTo(models.Users, { foreignKey: "updated_by", as: "updatedByUser" });
  }
}
