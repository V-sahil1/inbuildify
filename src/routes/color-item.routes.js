...
router.get("/:color_sub_category_id", validateRequest(getAllColorItemsParamsSchema, REQUEST_SOURCE.PARAMS), validateRequest(getAllColorItemsSchema, REQUEST_SOURCE.QUERY), getAllColorItems);
router.get("/item/:color_item_id", validateRequest(colorItemIdParamSchema, REQUEST_SOURCE.PARAMS), getColorItemById);
