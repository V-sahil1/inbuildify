...
const quotationFormatMasterSectionController = require("../controllers/quotation-format-master-section.controller");
...
const {
  ...
  paramsItemIdSchema,
} = require("../validations/quotation-format-master-section.validation");
